    ...
    <div class="container-fluid mt-7">
        <div class="row">
            <div class="col-lg-5 col-md-6 mb-4">
                <h3 class="tm-title-gray mb-4">About Apo Studio</h3>
                <hr class="mb-5 tm-hr">
                <p class="mb-5">
            Apo Studio adalah Penyedia Jasa Pembuat Dokumentasi pada suatu Event, dokumentasi dapat berupa foto maupun video sesuai keinginan pelanggan. Apo Studio memiliki tim yang profesional dan sudah berpengalaman dalam hal fotografi dan videografi.
            ...
            <div class="col-lg-6 col-md-6 mb-4 mr-0 ml-auto">
                ...
                <hr class="mb-5 tm-hr">
                <p class="mb-5">
                    Apo Studio berdiri pada 11 Januari 2021 di Surabaya. Apo Studio beranggotakan 10 orang. Apo Studio didirikan oleh Aporou. Seorang lulusan kampus ternama dalam jurusan Ilmu Komunikasi.
                </p>
                </p>
            </div>
        </div>
